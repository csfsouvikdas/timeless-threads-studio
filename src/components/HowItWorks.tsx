...
const steps = [
  {
    ...
    description: "Pick from hoodies, tees, sweatshirts, and more.",
  },
  {
    icon: Palette,
    title: "Submit Your Design",
    description: "Upload your crochet pattern or choose from our collection.",
  },
  {
    icon: Scissors,
    title: "Handmade Stitching",
    description: "Our artisans carefully stitch your design by hand.",
  },
  {
    icon: Package,
    title: "Delivered to You",
    description: "Your unique piece arrives beautifully packaged.",
  },
];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative z-10 mx-auto w-20 h-20 bg-pink/30 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors duration-300">
